...
export const Features = () => {
  ...
  const featuresData = [
    { id: 1, title: 'Project Size', value: '10.5 Acres' },
    { id: 2, title: 'Possession', value: '2029 ' },
    { id: 3, title: 'Starting Price', value: 'Rs 4 Cr*' },
    { id: 4, title: 'Configurations', value: '3 & 4 BHK' },
  ];

  return (
    <section className="w-full bg-PrestigeGrey">
      <div className="bg-[#1c1717] text-PrestigeGrey w-full transform -translate-y-1/2">
