    ...
    <section id="Location" className="max-w-full flex flex-col items-center bg-white">
      ...
      <div className="w-full flex flex-col md:flex-row items-center py-7 md:py-14 gap-6 md:gap-14">
        ...
        <div className="flex flex-col items-center md:items-start w-full px-6 md:pl-[7.5rem] md:justify-between gap-6 text-center md:text-left lg:max-w-lg"> 
          ...
          <div className="flex md:flex-col items-center md:items-start w-full  md:px-2 gap-2 md:gap-6 ">
            ...
            <ol className='text-left font-body text-xs md:text-base list-disc font-medium pl-1 md:pl-5 hidden sm:block space-y-3'>
                <li className=''>Kempegowda International Airport → 25 mins</li>
                <li className=''>ITC Factory, Bellary Road → 15 mins</li>
                <li className=''>KIADB Aerospace & Hardware Park → 25 mins</li>
                <li className=''>Hebbal / Mall of Asia → 10 mins</li>
                <li className=''>Manyata Tech Park → 15–20 mins</li>
          ...
          <div className="text-center md:text-left w-fit">
            <Button 
              ...
              onClick={() => window.open("https://maps.app.goo.gl/bTe4xFMpKVYV99ea8", "_blank")} // Opens Google Maps link in a new tab
            />
          </div>
        </div>
              {/* Google Maps Iframe */}
        <div className="w-full flex justify-center">
          ...
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3694.4508966945873!2d77.59392617507783!3d13.050638987272016!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae17cb5ad9130b%3A0x29c05b2d6161ba3e!2sEmbassy%20Astra%20(Sky%20Terraces)!5e1!3m2!1sen!2sin!4v1765545365830!5m2!1sen!2sin" 
